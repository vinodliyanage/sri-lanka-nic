...
2. **Day of year** — Must be between 1 and 366. The NIC system always treats every year as having 366 days (February always has 29 days), so 366 is valid for any birth year, not just leap years. See [How Birthday Dates Are Encoded](/docs/parsing#how-birthday-dates-are-encoded) for the full explanation.
