...
5. **Custom Validation (`check` callback)**: Finally, if you provided a `check` function in the config, it executes your custom rules. This guarantees your custom function only runs if the NIC is structurally and mathematically sound.
